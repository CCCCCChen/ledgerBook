...
router.get('/', (req, res) => {
  try {
    ...
    logger.error('[accounts] GET / error:', err.message);
...
router.get('/:id', (req, res) => {
  try {
    ...
    logger.error('[accounts] GET /:id error:', err.message);
...
router.post('/', (req, res) => {
  try {
    ...
    logger.error('[accounts] POST error:', err.message);
...
router.put('/:id', (req, res) => {
  try {
    ...
    logger.error('[accounts] PUT error:', err.message);
...
router.delete('/:id', (req, res) => {
  try {
    ...
    logger.error('[accounts] DELETE error:', err.message);
