...
router.get('/', (req, res) => {
  try {
    ...
    logger.error('GET /api/transactions error:', error.message);
...
router.get('/:id', (req, res) => {
  try {
    ...
    logger.error('GET /api/transactions/:id error:', error.message);
    res.status(500).json({ success: false, message: '获取交易记录失败', error: error.message });
  }
});
...
router.post('/', (req, res) => {
  try {
    ...
    logger.error('POST /api/transactions error:', error.message);
...
router.put('/:id', (req, res) => {
  try {
    ...
    logger.error('PUT /api/transactions/:id error:', error.message);
...
router.delete('/:id', (req, res) => {
  try {
    ...
    logger.error('DELETE /api/transactions/:id error:', error.message);
